...
public class ComandosBancos {
    ...
    public void inserirItem(FeedReaderDbHelper AppContext, String nome, String preco, String descricao, String caminhoIMG){
    ...
    public void inserirPedido(FeedReaderDbHelper AppContext, String idPedidos, String mesa){
        FeedReaderDbHelper mDbHelper = AppContext;
        SQLiteDatabase db = mDbHelper.getWritableDatabase();
    ...
    public void deletarItem(FeedReaderDbHelper AppContext, String nome){
        FeedReaderDbHelper mDbHelper = AppContext;
        SQLiteDatabase db = mDbHelper.getWritableDatabase();
    ...
    public void deletarPedido(FeedReaderDbHelper AppContext, String idPedido){
        FeedReaderDbHelper mDbHelper = AppContext;
        SQLiteDatabase db = mDbHelper.getWritableDatabase();
    ...
    public void alterarItem(FeedReaderDbHelper AppContext, String nome, String preco, String descricao, String caminhoIMG){
        FeedReaderDbHelper mDbHelper = AppContext;
        SQLiteDatabase db = mDbHelper.getWritableDatabase();
    ...
    public void alterarPedido(FeedReaderDbHelper AppContext, String idPedidos, String descricao, String total, String status){
        FeedReaderDbHelper mDbHelper = AppContext;
        SQLiteDatabase db = mDbHelper.getWritableDatabase();
    ...
    public ArrayList<String> lerItem(FeedReaderDbHelper AppContext){
        FeedReaderDbHelper mDbHelper = AppContext;
    ...
    public ArrayList<String> lerPedido(FeedReaderDbHelper AppContext){
        FeedReaderDbHelper mDbHelper = AppContext;
        SQLiteDatabase db = mDbHelper.getReadableDatabase();
